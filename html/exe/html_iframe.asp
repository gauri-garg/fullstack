...
<form autocomplete="off" id="w3-exerciseform" action="exercise.asp?filename=exercise_html_iframe1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>Create an iframe with a URL address that goes to https://www.w3schools.com.</p>
...
<p><a target="_blank" href="exercise.asp?filename=exercise_html_iframe1">Start the Exercise</a></p>
</div>
</form>
<hr>
